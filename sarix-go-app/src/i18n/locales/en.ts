export default {
  ...
  home: {
    ...
    chooseService: 'Pick a service and hit the road',
    orderTaxi: 'Order taxi',
    orderParcel: 'Send parcel',
    taxiSub: 'Get to your destination fast and in comfort',
    parcelSub: 'Document and parcel delivery service',
    fromCity: 'From',
    toCity: 'To',
  ...
  order: {
    ...
    payable: 'To pay',
    payableHint: 'Hand the driver exactly this amount in cash. The discount is covered from the driver commission.',
    bonusPendingHint: 'Your bonus discount is calculated when a driver accepts the ride, and will appear here.',
    ...
    useBonus: 'Use bonus',
    useBonusHint: 'You have {{amount}} UZS of bonus. The discount is calculated when a driver accepts the ride, and the amount usable on a single ride is capped.',
    cash: 'Cash',
    addCard: 'Add card',
    bonus: 'Bonus',
  ...
  referral: {
    ...
    heroTitle: 'Each friend = {{referrerBonus}} UZS',
    heroSubtitle: 'Your friend also gets a {{newUserBonus}} UZS bonus',
    yourCode: 'YOUR CODE',
    friends: 'Friends',
    bonus: 'Bonus (UZS)',
    share: 'Share',
    ...
    step3: 'When your friend COMPLETES their first ride — you get {{referrerBonus}} UZS',
    step4: 'And your friend gets {{newUserBonus}} UZS on each of their first {{rides}} rides',
    shareMessage: '\u{1F695} Sarix Go - Termiz Sariosiyo Taxi!\n\nI am inviting you — sign in to the app with this code and get a {{newUserBonus}} UZS bonus!\n\nCode: {{code}}\n\n{{link}}',
    codeCopied: 'Code copied',
    walletLabel: 'Your bonus balance',
    walletHint: 'Bonus is spent as a fare discount. The discount is calculated when a driver accepts the ride, and the amount usable on a single ride is capped.',
    haveCodeTitle: "Got a friend's code?",
    haveCodeHint: 'Enter it and get {{amount}} UZS on each of your first {{rides}} rides. A code can only be entered before your first ride.',
    codePlaceholder: 'ABC123',
    applyCode: 'Apply',
    codeAcceptedBody: '{{name}} invited you. Your {{amount}} UZS bonus arrives after you complete your first ride.',
    alreadyReferred: 'You have already used an invite code.',
  },
  bonusHistory: {
    title: 'Bonus history',
    open: 'View bonus history',
    empty: 'No bonus activity yet',
    emptyHint: 'Invite a friend or take a ride — your bonuses will appear here.',
    balanceAfter: 'Balance: {{amount}}',
    sourceReferral: 'Referral bonus',
    sourceLoyalty: 'Loyalty reward',
    sourcePromo: 'Promo code bonus',
    sourceAdmin: 'Added by an administrator',
    sourceRedeem: 'Ride discount',
    sourceRedeemOrder: 'Discount on order #{{id}}',
    sourceReversal: 'Bonus returned',
    sourceReversalOrder: 'Order #{{id}} cancelled — bonus returned',
    sourceOther: 'Bonus activity',
  },
  addresses: {
    title: 'My addresses',
