...
/**
 * What the driver sees when a screen fails to render.
 *
 ...
 *   1. Give the driver a way to continue (retry, or back to the home screen) instead of a
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text style={styles.secondaryText}>Zakaslar</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  secondaryText: { color: '#1E5BC4', fontSize: 16, fontWeight: '600' },
  detailsToggle: {
    marginTop: 20,
    fontSize: 13,
    color: '#656B78',
